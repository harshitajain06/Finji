...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const animateStats = () => {
      ...
      const timer = setInterval(() => {
        ...
        if (
          Object.values(currentStats).every(
            (val) =>
              val >=
              Object.values(targetStats)[
                Object.values(currentStats).indexOf(val)
              ],
          )
        ) {
          clearInterval(timer);
  ...
  const successStories = [
    ...
    },
    {
      ...
      story:
        "I was born in Guatemala and don't have a long enough credit history to get a loan here. This Finji loan bought a van and expanded my business.",
      business: "Florist",
      image:
  ...
  return (
    ...
    >
      ...
      <View style={styles.impactSection}>
        ...
        <Text style={styles.sectionSubtitle}>
          Finji helps people improve their livelihoods
        </Text>

        <View style={styles.statsGrid}>
          <View style={styles.statCard}>
            <Text style={styles.statNumber}>
              {impactStats.peopleReached.toLocaleString()}
            </Text>
            <Text style={styles.statLabel}>People Reached</Text>
          </View>
          <View style={styles.statCard}>
            <Text style={styles.statNumber}>
              ${(impactStats.loansFunded / 1000000000).toFixed(1)}B
            </Text>
      ...
      <View style={styles.relendSection}>
        ...
        <Text style={styles.relendText}>
          Just $25 can help many people over time.
        </Text>
      ...
      <View style={styles.aboutBox}>
        ...
        <Text style={styles.aboutText}>
          Finji connects people who want to make a difference with borrowers
          around the world. By lending as little as $25, you help entrepreneurs,
          farmers, and families access opportunities that change their lives.
          100% of your loan goes directly to funding dreams.
        </Text>
      </View>
        ...
        <View style={styles.stepsContainer}>
          <View style={styles.step}>
            ...
            <Text style={styles.stepText}>
              Browse borrowers and their stories
            </Text>
          </View>
          <View style={styles.step}>
            <View style={styles.stepIcon}>
          ...
          <View style={styles.step}>
            ...
            <Text style={styles.stepText}>
              Get repaid and re-lend to others
            </Text>
          </View>
          <View style={styles.step}>
            <View style={styles.stepIcon}>
